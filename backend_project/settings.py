...
# Celery task routes (optional)
CELERY_TASK_ROUTES = {
    'apps.users.tasks.send_email_task': {'queue': 'default'},
    'apps.users.tasks.send_otp_sms_task': {'queue': 'default'},
    'apps.users.tasks.send_trip_notification_task': {'queue': 'default'},
}
