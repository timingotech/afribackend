#!/usr/bin/env python
"""Post to local registration endpoint with a unique email variant to trigger OTP send locally."""
import requests
import json
import time

print("\n" + "="*70)
print("TESTING LOCAL REGISTRATION (ALT EMAIL) TO TRIGGER OTP")
print("="*70 + "\n")

# Use plus-addressing so the mailbox is the same but address is unique
test_email = f"taonuga01+local{int(time.time())}@gmail.com"
